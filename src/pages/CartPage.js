        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 mt-8">
            ...
            <p className="text-gray-600 text-lg ml-1">
              {cart.length > 0 ? `${cart.reduce((acc, item) => acc + item.quantity, 0)} ${cart.reduce((acc, item) => acc + item.quantity, 0) === 1 ? 'item' : 'items'} in your cart` : 'Your cart is waiting for beautiful candles'}
            </p>
          </div>
          ...
          {cart.length === 0 ? (
            <div className="bg-beige rounded-2xl p-12 sm:p-16 shadow-2xl text-center border-2 border-gray-200">
                ...
                <p className="text-gray-600 mb-8 text-lg">
                  Discover luxury candles and add your favorites to get started!
                </p>
                <button 
                  onClick={() => navigate("/")}
