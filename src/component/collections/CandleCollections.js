...
const CandleCollections = () => {
  ...
  return (
    <section id="collection" className="w-full py-16 px-[5%] bg-beige relative overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {collections.map((collection, index) => (
            <Link
              key={index}
              to={collection.link}
              className="group relative bg-beige rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 hover:transform hover:-translate-y-1 border border-gray-200 hover:border-gray-300"
            >
              {/* Product Image */}
              ...
              {/* Content */}
              <div className="p-4">
                <h3 className="text-lg font-semibold text-gray-900 mb-2 group-hover:text-[#D4A574] transition-colors duration-300">
                  {collection.name}
                </h3>
        ...
        {/* Special Banner */}
        <div className="mt-12 bg-gradient-to-r from-[#D4A574]/10 via-[#C08860]/10 to-[#D4A574]/10 rounded-2xl p-8 text-center border border-[#D4A574]/20">
          <p className="text-[#D4A574] text-lg md:text-xl font-semibold mb-2">
